...
# display = []
#
# for letter_in_display in chosen_word:
#     display.append("_")
#
...
while not end_of_game:
    ...
    if guess in display:
        print(f"You have already guessed letter {guess}, try another letter!")
    ...
    if guess not in chosen_word:
        ...
        print(f"Letter {guess} is not in the word, you have lost one life:(")
        lives -= 1
        if lives == 0:
            end_of_game = True
            print("You lose.")
